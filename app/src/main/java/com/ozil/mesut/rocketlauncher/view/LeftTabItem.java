...
/**
 * @author kui.liu
 * @time 2018/8/30 15:24
 */
public class LeftTabItem extends TabItem {
    public LeftTabItem(Context context, int imageNormal, int imagePress,
    ...
    public void setChecked(boolean isChecked) {
        ...
        if (null != view) {
            if (isChecked) {
                view.setBackground(context.getResources().getDrawable(R.drawable.left_tab_selected_shape));
            } else {
                view.setBackground(context.getResources().getDrawable(R.drawable.left_tab_normal_shape));
            }
        }
    }
}
